#include "MotorAssistLevelSmall.h"

#include <LvglThemes/lv_theme_binary.h>


MotorAssistLevelSmall::MotorAssistLevelSmall() {
...
lv_obj_t* MotorAssistLevelSmall::createLvObj(lv_obj_t* parent) {    
...
void MotorAssistLevelSmall::focusLvObj(BaseLvObject* defocusLvObj)
{
...
void MotorAssistLevelSmall::statusUpdate()
{
...
void MotorAssistLevelSmall::update() {
