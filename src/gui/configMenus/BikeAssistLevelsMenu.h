...
public:
	BikeAssistLevelsMenu(const char* menuTitle, BikeConfigAttributeIndex bikeConfigAttributeIndex, ConfigStore & configStore, lv_indev_t* indev, ButtonLabelBar* buttonLabelBar = NULL) :
