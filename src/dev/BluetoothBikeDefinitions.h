...
//     0x15 - Shuttle???
enum class EbikeStatusMotor { RIDER_POWER=0x00, CADENCE=0x01, SPEED=0x02, ODOMETER=0x04, ASSIST_LEVEL=0x05, UNKNOWN_6=0x06, TEMP=0x07, UNKNOWN_8=0x08, FIRMWARE_VERSION=0x0A, MOTOR_POWER=0x0C, PEAK_ASSIST=0x10, HARDWARE_NO_PART1=0x11, HARDWARE_NO_PART2=0x12, SERIAL_NO_PART1=0x13, SERIAL_NO_PART2=0x14, SHUTTLE=0x15 };
...
enum class EbikeStatusOther { WHEEL_CIRCUMFERENCE=0x00, UNKNOWN_1=0x01, UNKNOWN_2=0x02, ASSIST_ECO=0x03, ASSIST_TRAIL=0x04, ASSIST_TURBO=0x05, FAKE_CHANNEL=0x06, UNKNOWN_7=0x07, UNKONWN_8=0x08, BEEPER=0x09, FIRMWARE_VERSION=0x0A, BIKE_ON_OFF=0x0B, BIKE_SERIAL_NO=0x10, UNKNOWN_11=0x11 };
...
//   [0x01, 0x05] U-Int-16 Motor Assist Level
